...
export const deleteProduct = (id) => async (
 ...
 try {
   ...
   await axios.delete(
     `http://localhost:5000/api/products/${id}`,config
   )
...
export const createProduct = () => async (
 ...
 try {
   ...
   const {data}=await axios.post(
     `http://localhost:5000/api/products`,{},config
   )
...
export const updateProduct = (product) => async (
 ...
 try {
   ...
   const {data}=await axios.put(
     `http://localhost:5000/api/products/${product._id}`,product,config
   )
 ...
 export const createProductReview = (productId,review) => async (
  ...
  try {
    ...
    await axios.post(
      `http://localhost:5000/api/products/${productId}/reviews`,review,config
    )
